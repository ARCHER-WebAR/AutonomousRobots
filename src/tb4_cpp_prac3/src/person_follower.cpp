    ...
    if (param_type == ParameterType::PARAMETER_DOUBLE) {
      ...
      */
        ...
        if (following_angle_<0.0){
          RCLCPP_WARN(this->get_logger(), "You've set the following_angle to a negative value,"
          " this isn't allowed, so the angle will be set to zero.");
        ...
        RCLCPP_WARN(this->get_logger(), "Unknown parameter name");
      }
