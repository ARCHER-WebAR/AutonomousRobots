...
public:
    WallFollower(): Node("wall_follower")
    {
        ...
        */
        ...
        this->declare_parameter<float>("angle_control_gain_1", 3.0); //turning based on heading angle error
        this->declare_parameter<float>("angle_control_gain_2", 3.0); //turning based on distance error
